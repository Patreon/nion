...
describe('nion: reducers', () => {
  describe('references reducer', () => {
    ...
    it('filters out refsToDelete from all refs', () => {
      ...
      const deleteAction = makeAction(types.NION_API_SUCCESS, 'someDataKey', {
...
function makeAction(actionType, dataKey, { entryRef, ref, isNextPage, append, appendKey, refToDelete }) {
  return {
    type: actionType,
    payload: {
      dataKey,
