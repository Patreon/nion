...
describe('nion hooks-based decorator: should-rerender', () => {
  ...
  // Additional test to verify the hooks-based decorator is being used
  describe('hooks-based decorator verification', () => {
    it('should export the noin decorator function', () => {
      expect(noin).toBeDefined();
      expect(typeof noin).toBe('function');
    });
  });
});