  ...
  const mergeProps = (stateProps, dispatchProps, ownProps) => {
    ...
    mapDeclarations((declaration, key, dataKey) => {
      ...
      forEach(declaration.extensions, (options, extension) => {
        forEach(ExtensionManager.composeActionsForExtension(extension, options, resource), (action, actionKey) => {
          set(nextProps.nion, [key, `extensions`, extension, actionKey], action);
        });

        forEach(ExtensionManager.composeMetaForExtension(extension, options, resource), (metaValue, metaKey) => {
          set(nextProps.nion, [key, `extensions`, extension, `meta`, metaKey], metaValue);
        });
      });
