export class Lifecycle {
  onRequest({ method, dataKey, request, meta, declaration }) {
    return this._onRequest && this._onRequest({ method, dataKey, request, meta, declaration });
  }
  ...
  onFailure({ method, dataKey, error, meta, declaration }) {
    return this._onFailure && this._onFailure({ method, dataKey, error, meta, declaration });
  }
