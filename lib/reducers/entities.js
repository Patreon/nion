                    ...
                    entityNames.forEach(function (entityName) {
                        ...
                        for (var entityId in entityIndex) {
                            ...
                            for (var relationshipName in entity.relationships) {
                                if ((0, _utils.relationBelongsToEntity)(entity, relationshipName, id, type)) {
                                    nextState = (0, _utils.updateRelationships)(nextState, entityName, entityId, relationshipName, id, type);
                                }
                            }
                        }
                    });
