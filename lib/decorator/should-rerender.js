...
function dataAreEqual(prevData, nextData) {
    var safeKeys = function safeKeys(object) {
        return (
            ...
            (typeof object === 'undefined' ? 'undefined' : (0, _typeof3.default)(object)) === 'object' && object !== null ? Object.keys(object) : []
        );
    };
    ...
    return (0, _lodash4.default)(prevKeys, function (key) {
        if (!(0, _exists2.default)(prevData[key]) && !(0, _exists2.default)(nextData[key])) {
            return true;
        }
