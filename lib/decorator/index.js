...
var processDeclarations = function processDeclarations(inputDeclarations) {
    ...
    var defineDataProperty = function defineDataProperty(obj, key, value) {
        ...
        var mapStateToProps = function mapStateToProps(state, ownProps) {
            ...
            (0, _lodash6.default)(selectedResources, function (selected, selectedDataKey) {
                ...
                (0, _lodash6.default)(extraProps, function (prop) {
                    var extraProp = (0, _typeof3.default)(selected[prop]) === 'object' && (0, _lodash4.default)(declarations, selectedDataKey + '.apiType') !== 'api' ? (0, _extends3.default)({}, selected[prop]) : selected[prop];
...
var nion = function nion() {
    ...
    return function (WrappedComponent) {
        ...
        var connectedComponent = (0, _reactRedux.connect)(makeMapStateToProps, mapDispatchToProps, mergeProps)(WithNion);
