...
var processDeclarations = function processDeclarations(inputDeclarations) {
    ...
    var mergeProps = function mergeProps(stateProps, dispatchProps, ownProps) {
        ...
        mapDeclarations(function (declaration, key, dataKey) {
            var data = (0, _lodash4.default)(stateProps.nion, [key, 'data']);
            ...
            if (declaration.paginated) {
                ...
                if (pagination.canLoadMore) {
                    ...
                    nextProps.nion[key].request = nextProps.nion[key].request.set('canLoadMore', canLoadMore);
                }
            }
...
function exists() {
    ...
    var testExists = function testExists(obj) {
        return !!(obj.id && obj.type) || input._exists;
    };
...
function finalProcessProps(nionProp) {
    ...
    (0, _lodash6.default)(nionProp, function (dataProp, key) {
        ...
        var reconstructedData = data instanceof Array ? [].concat((0, _toConsumableArray3.default)(data)) : Object.create({ _exists: hasData });
