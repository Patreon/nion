    ...
    var mergeProps = function mergeProps(stateProps, dispatchProps, ownProps) {
        ...
        mapDeclarations(function (declaration, key, dataKey) {
            ...
            (0, _lodash6.default)(declaration.extensions, function (options, extension) {
                ...
                (0, _lodash6.default)(_extensions2.default.getActions(extension, options, resource), function (action, actionKey) {
                    (0, _lodash10.default)(nextProps.nion, [key, 'actions', actionKey], action);
                });

                // Get helper meta values from extensions
                (0, _lodash6.default)(_extensions2.default.getMeta(extension, options, resource), function (metaValue, metaKey) {
                    (0, _lodash10.default)(nextProps.nion, [key, 'extra', metaKey], metaValue);
                });
            });
