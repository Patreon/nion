...
function withNion(WrappedComponent) {
    ...
    return _temp = _class = function (_Component) {
            ...
            value: function initializeDataKeys(props) {
                ...
                (0, _lodash2.default)(nion._declarations, function (declaration, key) {
                    ...
                    if (declaration.fetchOnce) {
                        if ((0, _utilities.isNotLoaded)(status) && !isFetchPending) {
                            fetchesByDataKey[dataKey] = get().then(function () {
                                fetchesByDataKey[dataKey] = null;
                            });
                        }
                    } else {
                        if ((0, _utilities.isNotLoading)(status) && !isFetchPending) {
                            fetchesByDataKey[dataKey] = get().then(function () {
                                fetchesByDataKey[dataKey] = null;
                            });
                        }
        ...
        return WithNion;
    }(_react.Component), _class.displayName = 'WithNion(' + (0, _utilities.getDisplayName)(WrappedComponent) + ')', _class.propTypes = {
