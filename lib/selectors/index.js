...
var selectObject = exports.selectObject = function selectObject(key) {
    var returnAllObjects = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    return (0, _reselect.createSelector)(selectReferences, selectEntities, function (references, entityStore) {
        var ref = (0, _lodash2.default)(references, key);
        ...
        var denormalized = ref.entities.map(function (entityRef) {
            return (0, _denormalize2.default)(entityRef, entityStore, {}, returnAllObjects);
        });
...
var selectExtraRefProps = function selectExtraRefProps(key) {
    return (0, _reselect.createSelector)(selectRef(key), function (ref) {
...
var selectObjectWithRequest = exports.selectObjectWithRequest = function selectObjectWithRequest(key) {
    var returnAllObjects = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    return (0, _reselect.createSelector)(selectObject(key, returnAllObjects), selectRequest(key), selectExtraRefProps(key), function (obj, request, extra) {
        if (!returnAllObjects) {
        ...
        if (Array.isArray(obj)) {
            return (0, _extends3.default)({
                obj: obj.map(function (objAndList) {
                    return objAndList.obj;
                }),
                allObjects: obj.map(function (objAndList) {
                    return objAndList.allObjects;
                }),
                request: request
            }, extra);
        }
        return (0, _extends3.default)({
            obj: (0, _lodash2.default)(obj, 'obj'),
            allObjects: (0, _lodash2.default)(obj, 'allObjects'),
            request: request
        }, extra);
    });
};
...
var selectResourceForKey = exports.selectResourceForKey = function selectResourceForKey(dataKey) {
    return (0, _reselect.createSelector)(selectResourcesForKeys([dataKey]), function (data) {
        return data[dataKey];
    });
};
