...
var canLoadMore = exports.canLoadMore = function canLoadMore(data) {
    return !!(0, _lodash2.default)(data, 'extra.links.next') && !(0, _lodash2.default)(data, 'request.isLoading');
};

var getNextUrl = exports.getNextUrl = function getNextUrl(declaration, selectedData) {
    var nextUrl = (0, _lodash2.default)(selectedData, 'extra.links.next', null);
    return nextUrl;
};