...
var ExtensionManager = function ExtensionManager() {
    ...
    this.getActions = function (name, options, resource) {
        return _this.getExtension(name).generateActions(options, resource);
    };

    this.getMeta = function (name, options, resource) {
        return _this.getExtension(name).generateMeta(options, resource);
    };
