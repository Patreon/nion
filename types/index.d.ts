...
export function selectObjectWithRequest<T>(dataKey: string): OutputSelector<NionReduxState, T, any>;
...
export function bootstrapNion(store: NionReduxState, bootstrapObj: any, apiType?: string): void;
...
export type HOCDeclaration<Props> = ExpandedHOCDeclaration | DataKey | ((props: Props) => ExpandedHOCDeclaration);
